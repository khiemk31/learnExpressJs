module.exports = {
  ...
  queryListUser: `SELECT * FROM user WHERE deleted_at is null AND role='user'`,
  queryListAdmin: `SELECT * FROM user WHERE deleted_at is null AND role='admin' OR role='super admin'`,
  getSupperAdmin: `SELECT * FROM user WHERE deleted_at is null AND  role='super admin'`,
  getAllUserBlock: `SELECT * FROM user WHERE active = 1`,
};
